...
const CATEGORY_PRIORITY = ['Salud mental', 'Sociales', 'Apariencia', 'Académicos'] as const;

export function suggestReferralService(checkedAspects: ReferralAspectCode[]): ReferralService | null {
